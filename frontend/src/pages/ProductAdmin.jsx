       ...
       return (
           <section>
                 <div className='p-2  bg-white shadow-md flex items-center justify-between gap-4'>
                    ...
                    <div className='h-full min-w-24 max-w-56 w-full ml-auto bg-blue-50 px-4 flex items-center gap-3 py-2  rounded border border-primary-200
                      focus-within:border '
                     >
               ...
               <div className='p-4 bg-blue-50'>
                   ...
                   <div className='flex justify-between my-4'>
                    ...
                    <button  className='w-full bg-state-100'>{page}/{totalPageCount}</button>

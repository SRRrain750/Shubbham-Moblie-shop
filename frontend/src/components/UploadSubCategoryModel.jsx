...
const UploadSubCategoryModel = ({close}) => {
  ...
  return (
    <section className='fixed top-0 right-0 bottom-0 left-0 bg-neutral-800  bg-opacity-70z-50 flex items-center justify-center p-4'>
                       ...
                       <div className='flex flex-wrap gap-2'>
                        {
                            subCategoryData.category.map((cat,index)=>{
                                return(
                                    <p key={cat._id+"selected value "} className='bg-white shadow-md px-1 m-1 flex items-center gap-2'>{cat.name}
...
//                      </div>
//                      <label htmlFor='uploadSubCategoryImage'>
//                            <div className='px-4 py-1  border border-primary-100 text-primary-200 rounded
//                       hover:bg-primary-200 hover:text-neutral-900 cursor-pointer'>Upload Image
//                       </div>
//                       <input 
//                        type='file'
//                        id='uploadSubCategoryImage'

...
const AddToCartButton = ({ data }) => {
  ...
  return (
    <>
      ...
      {isCheckoutPage ? (
        /* 🔒 CHECKOUT PAGE */
        <div className="lg:hidden fixed bottom-0 left-0 w-full bg-gray-200 p-4 z-50">
          <button
            disabled
            className="w-full bg-gray-500 text-white py-4 text-lg rounded font-semibold cursor-not-allowed"
          >
            Order Processing...
          </button>
        </div>
        ...
        <div className="lg:hidden fixed bottom-0 left-0 w-full bg-white border-t p-3 z-50">
          {isAvailableCart ? (
            <div className="flex items-center justify-between">
              <button
                onClick={decreaseQty}
                className="bg-green-600 text-white w-12 h-12 rounded flex items-center justify-center"
              >
                <FaMinus />
              </button>
            ...
            <button
              onClick={handleAddToCart}
              className="w-full bg-green-600 text-white py-4 text-lg rounded font-semibold"
            >
...
//             <button
//               onClick={decreaseQty}
//               className="bg-green-600 text-white flex-1 p-1 rounded flex justify-center"
//             >
//               <FaMinus />
//             </button>

//             <p className="flex-1 font-semibold flex items-center justify-center">
//               {qty}
//             </p>
